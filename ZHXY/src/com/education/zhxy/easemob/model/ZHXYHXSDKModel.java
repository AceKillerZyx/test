 ...
 */
package com.education.zhxy.easemob.model;
...
import com.education.zhxy.easemob.db.DbOpenHelper;
import com.education.zhxy.easemob.db.UserDao;
import com.education.zhxy.easemob.domain.User;

public class  ZHXYHXSDKModel extends DefaultHXSDKModel{

    public ZHXYHXSDKModel(Context ctx) {
        super(ctx);
    }
