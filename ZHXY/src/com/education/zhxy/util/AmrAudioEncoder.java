...
public class AmrAudioEncoder {
	...
	private static AmrAudioEncoder playerInstance = null;
	...
	public static AmrAudioEncoder getAmrAudioPlayerInstance() {
		if (playerInstance == null) {
			synchronized (AmrAudioEncoder.class) {
				if (playerInstance == null) {
					playerInstance = new AmrAudioEncoder();
				}
			}
		}
	...
	private class NetAudioPlayerThread implements Runnable {
		...
		private Socket createSocketConnectToServer() throws Exception {
			String hostName = ReleaseConfigure.ROOT_IMAGE;
