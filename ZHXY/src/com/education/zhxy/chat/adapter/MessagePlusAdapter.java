...
public class MessagePlusAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.chat_function_layout, null);
			folder = new ViewFolder();
			folder.imagebtn = (ImageView) convertView.findViewById(R.id.messageFunctionBtn);
			folder.txtView = (TextView) convertView.findViewById(R.id.messageFunctionName);
