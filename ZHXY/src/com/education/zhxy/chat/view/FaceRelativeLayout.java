...
import com.education.zhxy.chat.adapter.FaceAdapter;
import com.education.zhxy.chat.adapter.FacePagerAdapter;
import com.education.zhxy.chat.adapter.MessagePlusAdapter;
import com.education.zhxy.chat.adapter.ViewPagerAdapter;
import com.education.zhxy.chat.data.bean.ChatEmoji;
import com.education.zhxy.chat.data.bean.MessagePlusEndity;
...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	protected void onFinishInflate() {
		...
		int[] a = new int[] { R.drawable.chat_location_selector,
				R.drawable.chat_album_selector, R.drawable.chat_call_selector,
				R.drawable.chat_camera_selector,R.drawable.chat_upload_selector };
		String[] str = new String[] { "位置","图片", "呼叫", "拍照", "上传" };
		for (int i = 0; i < 5; i++) {
	...
	public void Init_Point() {
		...
		for (int i = 0; i < pageViews.size(); i++) {
			...
			imageView.setBackgroundResource(R.drawable.chat_dot_normal);
			...
			if (i == 1) {
				imageView.setBackgroundResource(R.drawable.chat_dot_focused);
			}
			...
			public void onPageSelected(int arg0) {
				...
				if (arg0 == pointViews.size() - 1 || arg0 == 0) {
					if (arg0 == 0) {
						...
						pointViews.get(1).setBackgroundResource(R.drawable.chat_dot_normal);
					} else {
						vp_face.setCurrentItem(arg0 - 1);
						pointViews.get(arg0 - 1).setBackgroundResource(
								R.drawable.chat_dot_focused);
					}
				}
			}
	...
	public void Init_functionViewPager() {
		...
		for (int i = 0; i < function_list.size(); i++) {
			...
			MessagePlusAdapter adapter = new MessagePlusAdapter(context,function_list.get(i));
	...
	public void draw_Point(int index) {
		for (int i = 1; i < pointViews.size(); i++) {
			if (index == i) {
				pointViews.get(i).setBackgroundResource(R.drawable.chat_dot_focused);
			} else {
				pointViews.get(i).setBackgroundResource(R.drawable.chat_dot_normal);
			}
		}
	}
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (emoji.getId() == R.drawable.chat_face_del_icon) {
